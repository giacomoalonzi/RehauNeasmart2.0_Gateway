...
NEASMART_SYSBUS_BAUD = 38400  # Baud rate: 38400 Bits/s
NEASMART_SYSBUS_DATA_BITS = 8
NEASMART_SYSBUS_STOP_BITS = 1  # 1 stop bit
NEASMART_SYSBUS_PARITY = "N"  # None parity
NEASMART_SLAVE_ADDRESS_PRIMARY = 240  # Primary slave address
NEASMART_SLAVE_ADDRESS_SECONDARY = 241  # Secondary slave address
NEASMART_BYTE_ORDER = "MSB"  # Most Significant Byte first
NEASMART_REGISTER_START = 0  # First address "0"
